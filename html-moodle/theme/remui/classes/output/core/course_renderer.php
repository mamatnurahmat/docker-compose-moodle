        ...
        if (!empty($courses)) {
            ...
            foreach ($courses as $course) {
                ...
                $context = [
                    ...
                    'ernrshortdesign' => $rnrshortdesign,
                    "day" => $day,
                    "month" => $month,
                    "year" => $year,
                    "coursesummary" => $coursesummary,
                    "animation" => \theme_remui\toolbox::get_setting('courseanimation'),
                ];
                $contenthtml .= $this->render_from_template("theme_remui/frontpage_available_course", $context);
            }
            $contenthtml .= "</div>";
