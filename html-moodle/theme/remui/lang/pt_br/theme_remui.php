...
$string['choosereadme'] = 'remui é um tema altamente personalizável e moderno. Este tema é destinado a ser usado diretamente ou como um tema pai ao criar novos temas utilizando o Bootstrap 4.';
...
$string['courseperpagedesc'] = 'Número de cursos a serem exibidos por página na página do arquivo de curso.';
$string['none'] = 'Nenhum';
...
$string['enrolment_payment'] = 'Pagamento do curso';
$string['enrolment_payment_desc'] = 'Configurações para as preferências de inscrição no curso. Todos os cursos exigem pagamento, ou alguns são gratuitos? Essa configuração dita como a inscrição no curso funcionará e será exibida.';
$string['allrequirepayment'] = 'Todos os cursos exigem pagamento';$string['somearefree'] = 'Some courses are free';
...
$string['side-top'] = "Topo lateral";
$string['content'] = "Conteúdo";
$string['side-bottom'] = "Fundo lateral";
$string['side-pre'] = "Lateral pré";
