...
class local_edwiserform_license_controller {
    ...
    public $wdm_edwiserform_data = array (
        'plugin_short_name' => 'Edwiser Forms Pro', //Plugins short name appears on the License Menu Page
        'plugin_slug' => 'edwiser-form-pro', //this slug is used to store the data in db. License is checked using two options viz edd_<slug>_license_key and edd_<slug>_license_status
        'plugin_version' => '1.0.0', //Current Version of the plugin. This should be similar to Version tag mentioned in Plugin headers
        'plugin_name' => 'Edwiser Forms Pro', //Under this Name product should be created on WisdmLabs Site
    ...
    public function statusUpdate($license_data) {
        ...
        $dataobject->plugin         = 'local_edwiserform';
    ...
    public function addData() {
        if (is_siteadmin()) {
            ...
            if (isset($_POST[ 'edd_' . $this->plugin_slug . '_license_activate' ])) {
               ...
               set_config('licensekey', $lk, 'local_edwiserform');
               set_config('licensekeyactivate', @$_POST['edd_' . $this->plugin_slug . '_license_activate'], 'local_edwiserform');
               ...
               // jugad to tackle the page redirect after save license
               set_config('licensekey', $lk, 'local_edwiserform');
               set_config('licensekeydeactivate', @$_POST['edd_' . $this->plugin_slug . '_license_deactivate'], 'local_edwiserform');
