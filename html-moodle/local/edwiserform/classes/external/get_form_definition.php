...
trait get_form_definition {
    ...
    public static function get_form_definition_parameters() {
        return new external_function_parameters(
            ...
            'countries' => new external_value(PARAM_BOOL, 'If true then countries values will be sent', PARAM_DEFAULT, false)
                )
        );
    }
    ...
    public static function get_form_definition_returns() {
        return new external_single_structure(
            [
                ...
                'countries' => new external_value(PARAM_TEXT, 'Countries list', PARAM_DEFAULT, '')
            ]
        );
    }
