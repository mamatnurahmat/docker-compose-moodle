    ...
    public static function registration_action_parameters() {
        return new external_function_parameters(
            [
                ...
                "userid" => new external_value(PARAM_INTEGER, "User id", VALUE_REQUIRED),
                "action" => new external_value(PARAM_INTEGER, "Action to perform on user submission", VALUE_DEFAULT, "enrol")
            ]
        );
    }
    ...
    public static function registration_action_returns() {
        return new external_single_structure(
            [
                ...
                "type"   => new external_value(PARAM_INTEGER, "Visible action after updation")
            ]
        );
    }
}
