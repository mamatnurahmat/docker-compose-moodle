...
$string['efb-email-body-restore-desc'] = '<a href="#" class="efb-email-body-restore" data-id="{$a->id}" data-string="{$a->string}">Restore</a> email body to default.';
...
$string['efb-delete-form-user-files-cron-start'] = 'Deleting form user file of {$a}.';
$string['efb-delete-form-user-files-cron-failed'] = 'Deleting form user files of {$a} failed.';
$string['efb-delete-form-user-files-cron-end'] = 'Deleted form user files of {$a}.';
