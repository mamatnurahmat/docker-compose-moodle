...
$string['efb-email-body-restore-desc'] = '<a href="#" class="efb-email-body-restore" data-id="{$a->id}" data-string="{$a->string}">Restaurar</a> cuerpo del correo electrónico a predeterminado.';
...
$string['shortcodecoppied'] = '{$a} copiado al portapapeles';
...
/* Cron job string */
$strins['efb-cron-start'] = 'Edwiser Form Cron comenzó.';
...
$string['efb-enable-site-navigation'] = 'Habilitar la navegación usando la barra lateral';
$string['efb-desc-enable-site-navigation'] = 'Habilita esto para agregar enlaces de navegación en la barra lateral.';

// Usage tracking.
$string['enableusagetracking'] = "Habilitar el seguimiento de uso";
...
$string['efb-form-data-submission-successful'] = '<p> Formulario enviado correctamente. <a href="{$a}"> Haga clic </a> aquí para visitar la página principal. </p>';
...
$string['efb-delete-form-data-cron-start'] = 'Eliminando datos de formulario de {$a}.';
$string['efb-delete-form-data-cron-failed'] = 'Error al borrar los datos del formulario de {$a}.';
$string['efb-delete-form-data-cron-end'] = 'Se borraron los datos del formulario de {$a}.';
$string['efb-delete-form-cron-start'] = 'Eliminando el formulario {$a}.';
$string['efb-delete-form-cron-failed'] = 'Error al borrar el formulario {$a}.';
$string['efb-delete-form-cron-end'] = 'Se eliminó el formulario {$a}.';
$string['efb-delete-form-user-files-cron-start'] = 'Borrando el archivo de usuario de la forma de {$a}.';
$string['efb-delete-form-user-files-cron-failed'] = 'Error al borrar los archivos de usuario de la forma de {$a}.';
$string['efb-delete-form-user-files-cron-end'] = 'Se eliminaron los archivos de usuario de {$a}.';
