...
$string['efb-email-body-restore-desc'] = '<a href="#" class="efb-email-body-restore" data-id="{$a->id} "data-string =" {$a->string} "> Wiederherstellen </a> E-Mail Textkörper auf Standard.';
...
$string['shortcodecoppied'] = '{$a} In die Zwischenablage kopiert';
...
/* Cron job string */
$strins['efb-cron-start'] = 'Edwiser Form Cron gestartet.';
$string['efb-cron-end'] = 'Edwiser Form Cron durchgeführt.';
...
$string['efb-enable-site-navigation'] = 'Aktivieren Sie die Navigation über die Seitenleiste';
$string['efb-desc-enable-site-navigation'] = 'Aktivieren Sie diese Option, um Navigationslinks in der Seitenleiste hinzuzufügen.';

// Usage tracking.
$string['enableusagetracking'] = "Aktivieren Sie Usage Trakcing";
...
$string['efb-form-data-submission-successful'] = '<p> Formular erfolgreich gesendet. <a href="{$a}"> Klicken Sie hier </a>, um die Startseite zu besuchen. </p>';
...
$string['efb-delete-form-data-cron-start'] = 'Formulardaten von {$a} werden gelöscht.';
$string['efb-delete-form-data-cron-failed'] = 'Das Löschen der Formulardaten von {$a} ist fehlgeschlagen.';
$string['efb-delete-form-data-cron-end'] = 'Gelöschte Formulardaten von {$a}.';
$string['efb-delete-form-cron-start'] = 'Formular {$a} wird gelöscht.';
$string['efb-delete-form-cron-failed'] = 'Das Löschen des Formulars {$a} ist fehlgeschlagen.';
$string['efb-delete-form-cron-end'] = 'Gelöschtes Formular {$a}.';
$string['efb-delete-form-user-files-cron-start'] = 'Löschen der Formularbenutzerdatei von {$a}.';
$string['efb-delete-form-user-files-cron-failed'] = 'Das Löschen der Formularbenutzerdateien von {$a} ist fehlgeschlagen.';
$string['efb-delete-form-user-files-cron-end'] = 'Gelöschte Formularbenutzerdateien von {$a}.';
