...
$string['livecustomizer'] = "Open with Live Customizer";
...
$string['epbfpluginexistinfo'] = 'If you are facing an issue displaying some of the blocks please make sure the Edwiser Page Builder Filter plugin is enabled.<br> Navigate to <strong>Site Administration → Plugins → Filters  → Manage Filters</strong>. Here enable the Edwiser Page Builder Filter';
